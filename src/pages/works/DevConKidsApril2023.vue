<template>
    <div class="details-container">
        <header class="details-cover">
            <img src="/images/devcon-kids-april-2023/devcon-kids-april-2023-cover.webp" alt="">
        ...
        <main class="main">
            ...
            <div class="main__image-attachment">
                <img src="/images/devcon-kids-april-2023/devcon-kids-april-2023-screenshot.webp" alt="">
            </div>
            <p class="main__text t-regular details-text">
